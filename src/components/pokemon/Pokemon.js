...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    //Convert Decimeters
    const height =
      Math.round((pokemonRes.data.height * 1 + 0.0001) * 100) / 100;
    //Convert to lbs
    const weight =
      Math.round((pokemonRes.data.weight * 0.22462 + 0.0001) * 100) / 100;
  ...
  render() {
    return (
      <div className="col main_pokemon">
        <div className="card">
